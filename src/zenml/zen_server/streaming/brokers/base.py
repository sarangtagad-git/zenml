...
# Resume cursors are broker-defined: integer counter for the in-memory
# broker, `<ms>-<seq>` for Redis Streams. Validate a safe-shape envelope
# at the endpoint so malformed input doesn't surface as a 500 from the
# broker.
RESUME_CURSOR_PATTERN = re.compile(r"^[A-Za-z0-9.\-_]{1,64}$")
